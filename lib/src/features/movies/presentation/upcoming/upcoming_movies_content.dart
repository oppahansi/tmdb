...
import 'package:oppa_tmdb/src/features/movies/providers/movie_list_items_provider.dart';
...
class UpcomingMoviesContent extends ConsumerWidget {
  const UpcomingMoviesContent({super.key});
